    ...
    function generateIBAN(country, bankInfo) {
        ...
        try {
            switch (country) {
                ...
                case 'IT': nationalCheckPart = generateRandomChars(spec.nationalCheckLength, 'alphaUpper'); bankCodePart = bbanBankCode || generateRandomChars(spec.bankCodeLength, 'numeric'); branchCodePart = generateRandomChars(spec.branchCodeLength, 'numeric'); accountPart = generateRandomChars(spec.accountLength, 'numeric'); break;
